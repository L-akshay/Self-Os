...
import { loginWithEmail,GoogleSignin } from '../Firebase/auth';
    ...
    Login with Email
            ...
            <div className="flex justify-center">
              <button
                ...
                className="flex items-center gap-3 w-full text-white bg-indigo-600 hover:bg-indigo-700 px-5 py-3 rounded-md justify-center"
              >
                <img
